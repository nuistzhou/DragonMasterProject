...
mymap <-  leaflet() %>%
    ...
    addRasterImage(raster('data/0.5_0.5_0.5_1.tif'), colors = col_pal, opacity = 0.6,group="Greenest") %>%
     addRasterImage(raster('data/0.5_0.5_1_0.5.tif'), colors = col_pal, opacity = 0.6,group="Richest") %>%
     addRasterImage(raster('data/0.5_1_0.5_0.5.tif'), colors = col_pal, opacity = 0.6,group="Less hazards") %>%
#     addRasterImage(raster('data/1_0.5_0.5_0.5.tif'), colors = col_pal, opacity = 0.6,group="Less polution") %>%
     addLayersControl(
